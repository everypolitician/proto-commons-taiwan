        ...
        with fiona.open(villages_out_path, 'w',
            ...
            for feature in villages_shp:
                ...
                try:
                    ...
                    wiki_id = village_to_constituencies[village_code]
                    feature['properties']['WIKIDATA'] = wiki_id
                    ...
                    with open(missing_villages, 'a', encoding='utf-8') as f:
                        f.write('\ndistrict:{}, village:{}, code:{}'
                                .format(feature['properties']['TOWNNAME'],
                                        feature['properties']['VILLNAME'],
                                        feature['properties']['VILLCODE']))
                try:
